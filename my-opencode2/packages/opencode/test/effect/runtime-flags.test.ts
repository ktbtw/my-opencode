...
describe("RuntimeFlags", () => {
  ...
  it.effect("defaultLayer parses plugin flags from the active ConfigProvider", () =>
    Effect.gen(function* () {
      const flags = yield* readFlags.pipe(
        Effect.provide(
          fromConfig({
            ...
            OPENCODE_SEMANTIC_AGENT_ISOLATION: "true",
      ...
      expect(flags.semanticAgentIsolation).toBe(true)
  ...
  it.effect("layer accepts partial test overrides and fills defaults from Config definitions", () =>
    Effect.gen(function* () {
      ...
      expect(flags.semanticAgentIsolation).toBe(false)
  ...
  it.effect("semanticAgentIsolation defaults to false", () =>
    Effect.gen(function* () {
      const flags = yield* readFlags.pipe(Effect.provide(fromConfig({})))
  ...
  it.effect("semanticAgentIsolation reads OPENCODE_SEMANTIC_AGENT_ISOLATION", () =>
    Effect.gen(function* () {
      const flags = yield* readFlags.pipe(Effect.provide(fromConfig({ OPENCODE_SEMANTIC_AGENT_ISOLATION: "true" })))
