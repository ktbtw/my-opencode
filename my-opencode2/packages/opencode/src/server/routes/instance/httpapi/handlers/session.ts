...
export const sessionHandlers = HttpApiBuilder.group(InstanceHttpApi, "session", (handlers) =>
  Effect.gen(function* () {
    ...
    const todoHistory = Effect.fn("SessionHttpApi.todoHistory")(function* (ctx: { params: { sessionID: SessionID } }) {
      yield* requireSession(ctx.params.sessionID)
      return yield* todoSvc.list(ctx.params.sessionID)
    })
    ...
    return handlers
      ...
      .handle("todo", todo)
      .handle("todoHistory", todoHistory)
      .handle("diff", diff)
