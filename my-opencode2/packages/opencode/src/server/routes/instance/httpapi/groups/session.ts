...
export const SessionPaths = {
  ...
  todoHistory: `${root}/:sessionID/todo/history`,
  ...
  .add(
    HttpApiGroup.make("session")
      .add(
        ...
        HttpApiEndpoint.get("todoHistory", SessionPaths.todoHistory, {
          params: { sessionID: SessionID },
          query: WorkspaceRoutingQuery,
          success: described(Schema.Array(Schema.Array(Todo.Info)), "Todo history"),
          error: [HttpApiError.BadRequest, ApiNotFoundError],
        }).annotateMerge(
          OpenApi.annotations({
            identifier: "session.todoHistory",
            summary: "Get session todo history",
            description: "Retrieve all saved todo plan batches for a session in reverse chronological order.",
          }),
        ),
