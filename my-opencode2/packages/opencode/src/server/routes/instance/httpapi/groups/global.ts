...
const GlobalHealth = Schema.Struct({
  ...
  ok: Schema.optional(Schema.Literal(true)),
...
export const GlobalApi = HttpApi.make("global").add(
  HttpApiGroup.make("global")
    .add(
      HttpApiEndpoint.get("launcherHealth", GlobalPaths.launcherHealth, {
        success: described(GlobalHealth, "Launcher-compatible health information"),
      }).annotateMerge(
        OpenApi.annotations({
          identifier: "global.launcherHealth",
          summary: "Get launcher-compatible health",
          description: "Get health information using the legacy launcher-compatible path.",
        }),
      ),
