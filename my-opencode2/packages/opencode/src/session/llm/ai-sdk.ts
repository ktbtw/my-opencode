...
function finishReason(value: string | undefined, raw?: string): FinishReason {
  const normalizedRaw = raw?.trim().toLowerCase().replaceAll("_", "-")
  if (Schema.is(FinishReason)(normalizedRaw)) return normalizedRaw
