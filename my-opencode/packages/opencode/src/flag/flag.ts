...
export namespace Flag {
  ...
  export const OPENCODE_RELAY_URL = process.env["OPENCODE_RELAY_URL"]
  export const OPENCODE_RELAY_AGENT_ID = process.env["OPENCODE_RELAY_AGENT_ID"]
  export const OPENCODE_RELAY_MACHINE_ID = process.env["OPENCODE_RELAY_MACHINE_ID"]
  export const OPENCODE_RELAY_OPERATOR_KEY = process.env["OPENCODE_RELAY_OPERATOR_KEY"]
  export const OPENCODE_RELAY_TOKEN = process.env["OPENCODE_RELAY_TOKEN"]
  export const OPENCODE_RELAY_PROJECT_ID = process.env["OPENCODE_RELAY_PROJECT_ID"]
  export const OPENCODE_RELAY_PROJECT_ROOT = process.env["OPENCODE_RELAY_PROJECT_ROOT"]
  export const OPENCODE_RELAY_HOSTNAME = process.env["OPENCODE_RELAY_HOSTNAME"]
  export const OPENCODE_RELAY_PERMISSION_MODE = process.env["OPENCODE_RELAY_PERMISSION_MODE"]
